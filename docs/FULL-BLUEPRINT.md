# Full Blueprint (Original README)

> This file preserves the complete original README content for reference.
> For the streamlined version, see the root [README.md](../README.md).
